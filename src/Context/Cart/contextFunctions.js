        ...
        if (sellerExist) {
            ...
            if (!sellerProductAlreadyExist) {
                ...
                sellerProducts[sellerProducts.length] = { 
                    ...
                    sellerProfileImage: action.userProfileImage,
                    productId: action.productId,
                    productName: action.productName,
                    productImages: action.productImages,
                    productPrice: action.productPrice,
                    percentageOff: action.percentageOff,
...
function calculateCartTotalPrice(state = []) {
    ...
    for (let i = 0; i < allCartProducts.length; i++) {
        ...
        if (allCartProducts[i].percentageOff) {
            ...
            const percentOffPrice = (allCartProducts[i].percentageOff / 100) * Number(allCartProducts[i].productPrice)

            const newPrice = Number(allCartProducts[i].productPrice) - percentOffPrice;
